package com.eroshenkova.conference.db.dao;

import com.eroshenkova.conference.db.DAO;
import com.eroshenkova.conference.db.pool.ConnectionPool;
...
public abstract class AbstractDAO<K, T> implements DAO<K, T> {
    ...
    public int insertWithGeneratedKeys(T entity) {
        ...
        try (PreparedStatement statement = receiveCreateStatement(connection, entity)) {
            ...
            LOGGER.log(Level.ERROR, "Statement execution error");
        }
        return result;
    }
